...
def main():
    while True:
        ...
        cat_image = "/Users/ayushi/PycharmProjects/MeowCV/.venv/header/shock.jpg"
        if face_landmark_points:
            face_landmark_points = face_landmark_points[0]
            if cat_tongue(face_landmark_points):
                cat_image = "/Users/ayushi/PycharmProjects/MeowCV/.venv/header/tongue.jpeg"
            elif cat_shock(face_landmark_points):
                cat_image = "/Users/ayushi/PycharmProjects/MeowCV/.venv/header/shock.jpg"
            elif cat_glare(face_landmark_points):
                cat_image = "/Users/ayushi/PycharmProjects/MeowCV/.venv/header/glare.jpg"
            else:
                cat_image = "/Users/ayushi/PycharmProjects/MeowCV/.venv/header/disgust.jpeg"
